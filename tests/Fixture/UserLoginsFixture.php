...
class UserLoginsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ipv4_address' => ['type' => 'string', 'length' => 16, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'success' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'user_id' => 1,
            'created' => '2018-01-31 22:40:54',
            'ipv4_address' => 'Lorem ipsum do',
            'success' => 1,
