<?php
///////////////////////////////////////////////
// This element is for testing purposes only //
///////////////////////////////////////////////
...
<script type="text/javascript">
	$(function () {
	  var infoGroup = "";
		...
		infoGroup += '        <i class="fas fa-question-circle text-info info-icon" data-trigger="hover" data-toggle="popover" data-html="true" data-placement="right" data-content="<?= $content ?>"></i>';
		infoGroup += '    </span>';
		infoGroup += '</div>';
